...
| [[design-system]] | 2026-06-12 | Piloto UI design system: petrol+flame palette (light+dark tokens), status fill/text shades + badge mapping, type scale (14px floor), touch/density rules, canonical components (PageHeader, TableEmpty, Spinner, EmptyState, formatMoney), theme system. Hard-rule checklist for all future UI work. |
